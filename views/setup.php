			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="clan_tag" id="clan_tag" placeholder="np. DPA_E" tabindex="1"/>
					</div>
					<div class="form-group">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="accepted_absence" id="accepted_absence" placeholder="ilość dni np. 14" tabindex="3" value="14"/>
					</div>
					<div class="form-group">
						<label for="required_earnings" class="control-label">Minimalny okresowy przychód zasobów <small>(np. 300)</small></label>
						<input type="text" class="form-control" name="required_earnings" id="required_earnings" placeholder="np. 300"  tabindex="4" value="300"/>
					</div>
				</div>
			</div>
